					...
					?>
						<tr>
							...
							<td class="text-center">
								<!-- chaneg -->
                                <?php if($row['status'] == 0): ?>
                                    <span class="badge badge-success rounded-pill">Cash</span>
									<?php elseif($row['status'] == 2): ?>
                                    <span class="badge badge-success rounded-pill">Cheque</span>
                                <?php else: ?>
                                    <span class="badge badge-primary rounded-pill">online</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
