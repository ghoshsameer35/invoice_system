            ...
            <form action="" id="client-form">
                ...
                <div class="col-md-12">
                    <fieldset class="border-bottom border-info">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label for="gender" class="control-label text-info">PanNO/GST</label>
                                <input type="text" class="form-control form-control-sm rounded-0" id="gender" name="gender" value="<?php echo isset($gender) ? $gender : '' ?>" required>
                            </div>
                            <div class="form-group col-sm-4">
                                <label for="company_name" class="control-label text-info">Company Name</label>
                                <input type="text" class="form-control form-control-sm rounded-0" id="company_name" name="company_name" value="<?php echo isset($company_name) ? $company_name : '' ?>" required>
                            </div>
                            <div class="form-group col-sm-4">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                <label for="website" class="control-label text-info">Website</label>
                                <input type="text" class="form-control form-control-sm rounded-0" id="website" name="website" value="<?php echo isset($website) ? $website : '' ?>" placeholder="optional">
                            </div>
                            <?php if(isset($status)): ?>
