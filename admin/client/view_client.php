            ...
            <div class="row">
                <div class="col-md-6">
                    <dl>
                        ...
                        <dt class="text-info">PanNo/GST:</dt>
                        <dd class="fw-bold pl-3"><?php echo isset($gender) ? $gender : "" ?></dd>
                        <dt class="text-info">Company Name:</dt>
                        <dd class="fw-bold pl-3"><?php echo isset($company_name) ? $company_name : "" ?></dd>
                        <dt class="text-info">Website:</dt>
                        <dd class="fw-bold pl-3"><?php echo isset($website) ? $website : "" ?></dd>
                    </dl>
                </div>
                <div class="col-md-6">
                    <dl>
